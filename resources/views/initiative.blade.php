    ...
    <div class="row">
        <div class="col-md-6 d-flex align-items-center">
            <div>
                ...
                <h1 class="mb-4">
                    La Iniciativa Patagonia IA pone a Chile en el mapa de la inteligencia artificial con la
                    misma fuerza con que nuestra cordillera coloca a Chile en el centro de las discusiones sobre el futuro del planeta.
                </h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 text-white d-flex align-items-center">
                        <div>
                            ...
                            <p>
                                La Iniciativa <b>Patagonia IA</b> es un proyecto de soberanía nacional, reserva cultural, investigación e infraestructura.
                                Y por encima de todo, una estrategia que muestra al mundo cómo hacer todo esto respetando el medio ambiente con energía limpia y renovable.
                                Con un proyecto de Inteligencia Artificial tan rico como nuestra zona austral, Chile preservará su cultura, su historia, su lengua y su futuro.
                            </p>

                            <p>
                                Las nuevas generaciones no pueden aprender lo que significa ser chileno a través de la mirada de otros
                                países y de sus inteligencias artificiales cada vez más presentes en nuestra vida cotidiana.
                            </p>
                            ...
                            <p>
                                La Iniciativa Patagonia IA reunirá a algunos de los mayores nombres de nuestra investigación. Combatirá la fuga de cerebros que amenaza nuestra ciencia.
                            </p>

                            <p>
                                Cuando cada empresa logre hacer más y mejor usando Patagonia IA, serán chilenos potenciando a chilenos.
                                Cuando cada persona, de norte a sur y de cordillera a mar inicie una conversación con Patagonia IA, serán
                                chilenos estudiando, aprendiendo, trabajando, pensando y creando con otros chilenos.
                            </p>
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 pt-4">
                <div class="row">
                    <div class="col-12 col-sm-6 justify-content-center justify-content-lg-end d-flex align-items-center">
                        <img src="{{ asset('images/oracle.svg') }}" class="img-fluid" style="width:240px;">
                    </div>
                    <div class="col-12 col-sm-6 justify-content-center justify-content-lg-start d-flex align-items-center">
